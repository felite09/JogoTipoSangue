...
public class DiversiTime : MonoBehaviour
{
    ...
    List<Vector2> posicoes = new List<Vector2>(); // lista de vetores do tipo 3 chamada de posicoes que guarda cada posicao que o personagem ando
    List<Quaternion> rotacoes = new List<Quaternion>();// guarda a rotacao
    List<Vector2> rbVelocity =  new List<Vector2>(); // guarda a velocidade 
    List<Vector2> rbAngularVelocity = new List<Vector2>(); // guarda angulo e velocidade
    Rigidbody rb;
